...
download \
    "https://get.helm.sh/helm-${HELM_VERS}-${OS}-amd64.tar.gz" \
    "${DESTDIR}/helm.tar.gz"

tar -xzvf "${DESTDIR}/helm.tar.gz" -C "${DESTDIR}" --strip-components 1 "${OS}-amd64/helm"
rm "${DESTDIR}/helm.tar.gz"
